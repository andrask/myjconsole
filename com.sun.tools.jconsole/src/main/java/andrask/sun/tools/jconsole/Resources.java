...
import andrask.sun.tools.jconsole.resources.JConsoleResources;
...
public final class Resources {
    ...
    static {
        try {
            resources =
                (JConsoleResources)ResourceBundle.getBundle("andrask.sun.tools.jconsole.resources.JConsoleResources");
